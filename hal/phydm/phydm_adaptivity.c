	...
	if (pDM_Odm->SupportAbility & ODM_BB_ADAPTIVITY) {
...
#endif
		{
			if (Adaptivity->DynamicLinkAdaptivity == TRUE) {
				...
				if (pDM_Odm->SupportICType & (ODM_RTL8814A | ODM_RTL8195A | ODM_RTL8703B))
					pDM_Odm->adaptivity_flag = FALSE;
				else
...
#if ((RTL8195A_SUPPORT == 1) || (RTL8703B_SUPPORT == 1))
	if (pDM_Odm->SupportICType & (ODM_RTL8195A | ODM_RTL8703B)) {
