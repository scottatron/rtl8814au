...
#define	RTL8188F_TRANS_ACT_TO_LPS_STEPS		23
#define	RTL8188F_TRANS_LPS_TO_ACT_STEPS		14	
#define	RTL8188F_TRANS_ACT_TO_SWLPS_STEPS		22
#define	RTL8188F_TRANS_SWLPS_TO_ACT_STEPS		15
...
#define RTL8188F_TRANS_CARDEMU_TO_ACT 														\
	...
	{0x0027, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, 0xff, 35},/* 0x27<=35 to reduce RF noise*/
...
#define RTL8188F_TRANS_ACT_TO_CARDEMU													\
	...
	{0x0027, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, 0xff, 34},/*0x27 <= 34, xtal_qsel=0 to xtal bring up*/\
...
#define RTL8188F_TRANS_ACT_TO_LPS														\
	...
	{0x0008, PWR_CUT_ALL_MSK, PWR_FAB_ALL_MSK, PWR_INTF_ALL_MSK,PWR_BASEADDR_MAC,PWR_CMD_WRITE, BIT4,BIT4}, /* switch TSF clock to 32K*/	\
