...
static struct usb_device_id rtw_usb_id_tbl[] ={
	...
	{USB_DEVICE(0x2001, 0x331a),.driver_info = RTL8814A}, /* D-Link - ALPHA */
	{USB_DEVICE(0x2357, 0x0106),.driver_info = RTL8814A}, /* TP-Link - ALPHA */
...
static void rtw_decide_chip_type_by_usb_info(_adapter *padapter, const struct usb_device_id *pdid)
{
	...
	#ifdef CONFIG_RTL8188F
	if (padapter->chip_type == RTL8188F)
		rtl8188fu_set_hw_type(padapter);
	#endif
}
